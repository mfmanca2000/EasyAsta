          ...
          {selectedTeam ? (
                  ...
                  <div className="grid grid-cols-4 gap-4 text-center">
                    <div className="space-y-2">
                      ...
                      <div className={`text-lg font-bold ${
                        composition.P === 3 ? 'text-green-600' : 'text-orange-600'
                      }`}>
                        {composition.P}/3
                      </div>
                    ...
                    <div className="space-y-2">
                      {getPositionBadge('D')}
                      <div className={`text-lg font-bold ${
                        composition.D === 8 ? 'text-green-600' : 'text-orange-600'
                      }`}>
                        {composition.D}/8
                      </div>
                    ...
                    <div className="space-y-2">
                      {getPositionBadge('C')}
                      <div className={`text-lg font-bold ${
                        composition.C === 8 ? 'text-green-600' : 'text-orange-600'
                      }`}>
                        {composition.C}/8
                      </div>
                    ...
                    <div className="space-y-2">
                      {getPositionBadge('A')}
                      <div className={`text-lg font-bold ${
                        composition.A === 6 ? 'text-green-600' : 'text-orange-600'
                      }`}>
                        {composition.A}/6
                      </div>
            ...
            <Card>
              <CardContent className="py-12 text-center">
                ...
                <p className="text-muted-foreground">
                  Scegli una squadra dalla lista a sinistra per visualizzare la sua rosa.
                </p>
              </CardContent>
            </Card>
          )}
