                    ...
                    {teamsWithSelection.map((team) => {
                      ...
                      return (
                        <SelectItem key={team.id} value={team.id}>
                          <div className="flex items-center justify-between w-full">
                            <span>{team.name}</span>
                            {selection && <Badge variant={selection.isAdminSelection === true ? "destructive" : "default"}>{selection.player.name}</Badge>}
                          </div>
                        </SelectItem>
                      );
                    })}
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Input type="number" min="10" max="300" value={timeoutSeconds} onChange={(e) => setTimeoutSeconds(parseInt(e.target.value))} />
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch checked={autoSelectOnTimeout} onCheckedChange={setAutoSelectOnTimeout} />
              </div>
